...
public class Dev_UIManager : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       // GAScript.LevelStart(PlayerPrefs.GetInt("levelnumber", 1), levelAttempts);
        ...
        //Dev_AudioManager.instance.Play("BACKGROUND");
    }
    ...
    public void NextlevelButton()
    {
        ...
        {
            Dev_AudioManager.instance.Play("Button");
            Dev_GameManager.instance.vibration();
        }
