...
public class Dev_Wednesday : MonoBehaviour
{
    public static Dev_Wednesday instance;
    ...
    public void weddone()
    {
            ...
            seq.Append(Hand.transform.parent.DOMove(new Vector3(0, -1.2f, 0f), 1f).SetEase(Ease.Linear).OnComplete(
                () =>
                {
                    ...
                    DOVirtual.DelayedCall(1.5f, () =>
                    {
                        ...
                        {
                            Dev_AudioManager.instance.Play("Punch");
                        }
                    });
        ...
        seq.AppendCallback(() =>
        {
            ...
            Player.GetComponent<SplineFollower>().spline = Dev_GameManager.instance.playerspline;
                        ...
                        DOVirtual.DelayedCall(0.5f, () =>
                        {
                            Hand.transform.parent.DOMove(Player.transform.position, 3f).SetEase(Ease.Linear).OnComplete(
                                () =>
                                {
                                    ...
                                    {
                                        Dev_GameManager.instance.winning();
                                    }
                                });
